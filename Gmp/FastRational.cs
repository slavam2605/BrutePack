...
namespace BrutePack.Gmp
{
  ...
  internal struct mpq_t
  {
    ...
    public struct WholeFractionParts
    {
        public readonly Integer Whole;
        public readonly Rational Fraction;

        public WholeFractionParts(Integer whole, Rational fraction)
        {
            Whole = whole;
            Fraction = fraction;
        }
  ...
  public class Rational: IComparable, IComparable<Rational>, ICloneable
  {
    ...
    public Rational(Rational value):this()
    {
      ...
      private Rational(Integer num, mpz_t den):this()
      {
          mpq_set_num(ref _pointer, ref num._pointer);
          mpq_set_den(ref _pointer, ref den);
          mpq_canonicalize(ref _pointer);
      }
    ...
    {
      if (obj is Rational || obj is double || obj is Integer || obj is int) return CompareTo((Rational) obj);
    ...
    public void PlusAssign(Rational other)
    {
      mpq_add(ref _pointer, ref _pointer, ref other._pointer);
    }

      public void SubAssign(Rational other)
      {
          mpq_sub(ref _pointer, ref _pointer, ref other._pointer);
      }

      public void DivAssign(Rational other)
    {
      mpq_div(ref _pointer, ref _pointer, ref other._pointer);
    }

    public void MulAssign(Rational other)
    {
      mpq_mul(ref _pointer, ref _pointer, ref other._pointer);
    }
    ...
    public Rational Inverse()
    {
      ...
      public WholeFractionParts GetWholeAndFraction()
      {
          Integer modulo = new Integer();
          Integer whole = new Integer();
          Integer.mpz_tdiv_qr(ref whole._pointer, ref modulo._pointer, ref _pointer._mp_num, ref _pointer._mp_den);
          return new WholeFractionParts(whole, new Rational(modulo, _pointer._mp_den));
      }

      public Rational GetFractionPart()
      {
          Integer modulo = new Integer();
          Integer.mpz_mod(ref modulo._pointer, ref _pointer._mp_num, ref _pointer._mp_den);
          return new Rational(modulo, _pointer._mp_den);
      }

      /// <summary>
    /// Performs an explicit conversion from <see cref="System.Double"/> to <see cref="Rational"/>.
